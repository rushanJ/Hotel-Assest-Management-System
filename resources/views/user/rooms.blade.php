...
<section class="ftco-section bg-light ftco-no-pb">
	...
	<!-- {{ $dataset}} -->
		@foreach($dataset as $Past)
		
		@if($Past->guestCount == $count )
						
		 @if( $Past->category_id ==$type)		 
			<div class="col-lg-6">
				<div class="room-wrap d-md-flex">
					<a href="rooms-single.html" class="img" style="background-image: url(../storage/{{$Past->image}});"></a>
					<div class="half left-arrow d-flex align-items-center">
						<div class="text p-4 p-xl-5 text-center">
							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
							<p class="mb-0"><span class="price mr-1">${{$Past->price}}</span> <span class="per">per night</span></p>
							<h3 class="mb-3"><a href="rooms-single.html">{{$Past->type}} Room</a></h3>
							<p class="pt-1"><a href="rooms-single?startDate={{ $startDate }}&endDate={{ $endDate }}&id={{$Past->id}}&count={{ $count }}" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
						</div>
					</div>
				</div>
			</div>
