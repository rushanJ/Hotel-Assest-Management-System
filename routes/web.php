...
Route::get('api/roomLock', 'Admin\RoomsController@roomLock');

Route::get('/', 'Auth\LoginController@showLoginForm')->name('auth.login');
Route::get('/home_rooms', 'WelcomeController@home_rooms');
Route::get('/rooms-single', 'WelcomeController@rooms_single');
Route::post('book', 'WelcomeController@book')->name('book');

Route::get('/index', 'WelcomeController@index');
Route::get('/about', 'WelcomeController@about');
Route::get('/contact', 'WelcomeController@contact');
// Route::get('pay', 'WelcomeController@book');
...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::post('suppliers_mass_destroy', ['uses' => 'Admin\RoomsController@massDestroy', 'as' => 'supplier.mass_destroy']);
    Route::post('suppliers_restore/{id}', ['uses' => 'Admin\RoomsController@restore', 'as' => 'rooms.restore']);
    Route::delete('suppliers_perma_del/{id}', ['uses' => 'Admin\RoomsController@perma_del', 'as' => 'rooms.perma_del']);

    Route::resource('item', 'Admin\ItemController');
    Route::post('rooms_mass_destroy', ['uses' => 'Admin\RoomsController@massDestroy', 'as' => 'item.mass_destroy']);
    Route::post('rooms_restore/{id}', ['uses' => 'Admin\RoomsController@restore', 'as' => 'rooms.restore']);
    Route::delete('rooms_perma_del/{id}', ['uses' => 'Admin\RoomsController@perma_del', 'as' => 'rooms.perma_del']);

    Route::resource('clean', 'Admin\CleanController');
